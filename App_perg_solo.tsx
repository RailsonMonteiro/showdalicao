...
export interface AppPergSoloProps {
  question?: Question;
  team?: GameTeam;
...
function LiquidTimer({ timeLeft, maxTime, isRunning, onStart }: {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
      <style>{`
        @keyframes liq-wave-solo {
          0%   { transform: translateX(0); }
          100% { transform: translateX(-50%); }
        }
        @keyframes liq-pulse-solo {
      ...
      <div
        ...
        style={{
          ...
          animation: isRunning && timeLeft <= 3 ? 'liq-pulse-solo 0.6s ease-in-out infinite' : 'none',
        }}
      >
        {/* Liquid fill */}
        {isRunning && (
          <div style={{
            ...
            <svg
              ...
              style={{
                ...
                top: -12, left: 0,
                width: '200%', height: 24,
                animation: 'liq-wave-solo 1.6s linear infinite',
              }}
            >
              <path
...
export default function AppPergSolo({
  ...
  const c1 = getBaseColor(team.grad);
  ...
  const isPwrUsed = (k: string) => powerUpsUsed.has(k);
  const usePwr = (k: string) =>
    setPowerUpsUsed(s => { const n = new Set(s); n.add(k); return n; });

  return (
    <div style={{
      width: '100vw', height: '100vh',
      background: `radial-gradient(ellipse 105% 105% at 0% 0%, ${c1}cc 0%, ${c1}44 46%, transparent 63%), radial-gradient(ellipse 105% 105% at 100% 100%, ${c1}cc 0%, ${c1}44 46%, transparent 63%), #060610`,
      ...
      <main style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 28 }}>
          ...
          <div style={{
            ...
            position: 'relative',
            overflow: 'hidden',
            boxShadow: `0 4px 20px ${team.glow}`,
            border: 'none',
          }}>
            <div style={{
            ...
            <div style={{
              ...
              {team.score.toLocaleString('pt-BR')} pts
            </div>
          </div>
